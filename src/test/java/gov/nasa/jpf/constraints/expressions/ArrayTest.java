...
public class ArrayTest {
    ...
    public void arrayTestJConstraints() {
        ...
        ctx.add(numBo);
        ConstraintSolver.Result result = solver.solve(numBo, valuation);
        System.out.println(arrayStore1);
        System.out.println(arraySelect1);
        System.out.println(numBo);
        System.out.println(result);
        System.out.println(valuation);
        Assert.assertEquals(solver.isSatisfiable(numBo), ConstraintSolver.Result.SAT);
    }
